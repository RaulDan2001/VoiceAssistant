...
class SpeechLogic(object):
    ...
    def translate_and_speak(self,text, src_lang, target_lang):
        ...
        self.text_to_speech(translation, target_lang)
    ...
    def speech_run(self):
        while True:
            ...
            if choice == '3':
                ...
                self.translate_and_speak(user_input, src_lang, target_lang)
            elif choice == '2':
                ...
                recognized_text = self.speech_to_text(src_lang)
                if recognized_text:
                    self.translate_and_speak(recognized_text, src_lang, target_lang)
            else:
